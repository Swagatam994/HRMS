...
import { BarChart3, BriefcaseBusiness, History, LifeBuoy, LogOut, MessageCircleMore, Moon, Sun, UserRound } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="lg:pl-64">
        <NavLink
          to="/support"
          className="fixed bottom-6 right-3 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-blue-500 text-white shadow-xl shadow-blue-500/30 transition hover:scale-105 hover:bg-blue-400 sm:bottom-8 sm:right-5"
